'use client';
//src/components/calendario/ProximaCorridaCountDown.tsx (componente para usar na home)
import type { CountdownUnitProps, ProximaCorridaData } from '@/types/sanity'; // Alias ajustado
...
const ProximaCorridaCountdown = ({
  ...
  }, [eventData.evento?.data, eventData.nomeDoEvento]); // Incluir eventData.nomeDoEvento na dependência
